 ...
 * @author Sean Owen
 */
public class GlobalHistogramBinarizerFine extends Binarizer {
    ...
    public GlobalHistogramBinarizerFine(LuminanceSource source) {
        super(source);
        luminances = EMPTY;
    ...
    public Binarizer createBinarizer(LuminanceSource source) {
        return new GlobalHistogramBinarizerFine(source);
    }
